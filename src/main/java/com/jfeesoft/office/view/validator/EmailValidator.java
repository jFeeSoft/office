...
import com.jfeesoft.office.view.utils.Constans;
...
public class EmailValidator implements Validator {
    ...
    public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
        ...
        if(!pattern.matcher(value.toString()).matches()) {
            FacesMessage msg =
                    new FacesMessage(null,messagesBundle.getString("message.error.incorrectEmail"));
        ...
        if(userService.existEmail((String)value)){
            FacesMessage msg =
                    new FacesMessage(null,messagesBundle.getString("message.error.emailConstraintViolation"));
            msg.setSeverity(FacesMessage.SEVERITY_ERROR);
            throw new ValidatorException(msg);
        }
    }
